...
class EpisodeMapper extends Mapper
{
    ...
    function getEpisodesBy(?PDO $pdo, $animeId, $season, $idEpisodeType, $number, $idLangType, PlatformMapper $platformMapper, AnimeMapper $animeMapper, CountryMapper $countryMapper, EpisodeTypeMapper $episodeTypeMapper, LangTypeMapper $langTypeMapper): ?array
    {
